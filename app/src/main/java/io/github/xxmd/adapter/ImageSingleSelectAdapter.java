...
public class ImageSingleSelectAdapter extends io.github.xxmd.SingleSelectAdapter<String, ImageSingleSelectAdapter.ViewHolder> {

    public ImageSingleSelectAdapter(List<String> itemList) {
        super(itemList);
    }
